...
Use this when you want to connect to a Vaia Code server from another device such as a phone, tablet, or separate desktop app.
...
Use this when you want the desktop app to start or reuse Vaia Code on another machine over SSH.
...
Hosted pairing does not proxy traffic through Vaia Code. The browser still connects directly to the backend URL in the pairing link.
