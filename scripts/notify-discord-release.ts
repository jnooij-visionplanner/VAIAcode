  ...
  embeds: [
    {
      ...
      description:
        options.target === "prerelease"
          ? "A new Vaia Code prerelease is available for nightly testers."
          : "A new Vaia Code latest release is available.",
...
).pipe(Command.withDescription("Post a Vaia Code release announcement to Discord."));
