...
export interface CursorAdapterLiveOptions {
  ...
  readonly makeRuntime?: (input: {
    ...
    readonly requestLogger?: Parameters<typeof makeCursorAcpRuntime>[0]["requestLogger"];
...
function applyRequestedSessionConfiguration<E>(input: {
  ...
  readonly runtimeMode: RuntimeMode;
  readonly interactionMode: ProviderInteractionMode | undefined;
  readonly applyModelSelection?: CursorAdapterLiveOptions["applyModelSelection"];
      ...
      const applyModelSelection =
        ...
        ((selectionInput) =>
          applyCursorAcpModelSelection({
            runtime: selectionInput.runtime,
            model: selectionInput.model,
            selections: selectionInput.selections,
            mapError: ({ cause }) =>
              selectionInput.mapError({
                cause,
...
export function makeCursorAdapter(
  ...
  return Effect.gen(function* () {
    ...
    const enableCursorExtensions = options?.enableCursorExtensions ?? provider === PROVIDER;
